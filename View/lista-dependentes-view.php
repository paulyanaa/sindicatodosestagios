...
<main>
            ...
            <table>
                ...
                <?php foreach($aDependentes as $dependente):?>
                    <tr>
                        ...
                        <?php if($bAparecerBotao): ?>
                            <td>
                                <form action="<?php echo Ambiente::getUrl('dependente/editar')?>" method="post">
                            ...
                            <td>
                                <form action="<?php echo Ambiente::getUrl('dependente/deletar')?>" method="post">
                                    <input type="hidden" name="dpe_id" value="<?php echo $dependente->getIId() ?>">
                                    <input type="hidden" name="flo_id" value="<?php echo $dependente->getIIdFiliadoAssociado()?>">
    ...
    <?php if($bAparecerBotao): ?>
        <a class="botao-voltar-menu" href="<?php echo Ambiente::getUrl('dependente/cadastrar')?>?flo_id=<?= $iIdFiliadoAssociado?>">Cadastrar Novo Dependente</a><br>
    <?php endif?>


    <a class="botao-voltar-menu" href="<?php echo Ambiente::getUrl('filiado/listar')?>">Voltar</a>
